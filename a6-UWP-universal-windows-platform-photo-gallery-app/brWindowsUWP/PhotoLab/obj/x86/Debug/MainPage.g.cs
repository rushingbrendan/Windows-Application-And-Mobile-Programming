#pragma checksum "C:\Users\brushing0895\Downloads\Windows-appsample-photo-lab-master\WindowsUWP\xaml-basics-starting-points\style\PhotoLab\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "685B55974E5895A5C77FB4AF2E478E42"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace PhotoLab
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IMainPage_Bindings
        {
            ...
            {
                if (lineNumber == 131 && columnNumber == 24)
                {
                ...
                else if (lineNumber == 142 && columnNumber == 48)
                {
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 99 && columnNumber == 45)
                {
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                {
                    this.obj15.ValueChanged -= obj15ValueChanged;
                }
                else if (lineNumber == 62 && columnNumber == 31)
                {
                    this.obj16.Toggled -= obj16Toggled;
                }
                else if (lineNumber == 183 && columnNumber == 19)
                {
                    isobj19ItemsSourceDisabled = true;
                }
                else if (lineNumber == 187 && columnNumber == 19)
                {
                    this.obj19.Loaded -= obj19Loaded;
                }
            }
